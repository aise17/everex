...
public class PanelListaExamenes extends  JPanel{
    ...
    private void instanciarControles(){
        ...
        tituloFormulario = new JLabel("Lista Examenes");
        ...
        tableScroll = new JScrollPane(tablaExamenes);
    ...
    public JTable getTablaExamenes() {
        return tablaExamenes;
    }

    public void setTablaExamenes(JTable tablaExamenes) {
