...
public class PanelListaProfesores extends  JPanel{
    ...
    private void instanciarControles(){
        ...
        tituloFormulario = new JLabel("Lista Profesores");
        ...
        tableScroll = new JScrollPane(tablaProfesores);
